...
export default function AddAssetScreen() {
  ...
  const initialAsset: Asset = assetData
  ...
  const [selectedEmployeeId, setSelectedEmployeeId] = useState(
    asset?.current_person || null
  );
  const [selectedLocationId, setSelectedLocationId] = useState(
    asset?.current_location || null
  );
        ...
        <View style={globalStyles.modalWindow}>
          {cameraPermission?.granted && (
            <CameraView
              ...
              onBarcodeScanned={
                cameraMode === "scan" ? barcodeScanned : undefined
              }
            />
          )}
        ...
        <ScrollView style={globalStyles.infoContainer}>
          ...
          <View style={globalStyles.buttonViewH}>
            <TextInput
              ...
              onChangeText={(text) =>
                setAsset({ ...asset, barcode: parseInt(text) || 0 })
              }
          ...
          <TextInput
            inputMode="decimal"
            onChangeText={(text) =>
              setAsset({ ...asset, price: parseFloat(text) || 0 })
            }
            style={globalStyles.textInput}
          />
